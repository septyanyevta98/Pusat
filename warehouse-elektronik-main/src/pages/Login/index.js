...
import {PayloadLoginBody, login} from '../../redux/auth/login';
    ...
    dispatch(login({PayloadLoginBody: payload}))
      .then((res) => {
        ...
        if (res.code === 200) {
          ...
          Toast.show('Silahkan Periksa Kembali Username/Password Anda!');
        }
      })
      ...
      <View style={styles.page}>
        <View style={styles.content}>
          <View style={{alignItems: 'center'}}>
            ...
            />
            <Text style={styles.welcome}>Welcome to Warehouse App</Text>
